...
import { ExpenseCatInterfaceData } from 'src/app/inventual/data/expenseCategoryData';
...
@Component({
  ...
  styleUrls: ['./listexpense.component.scss']
})
export class ListexpenseComponent implements AfterViewInit {
