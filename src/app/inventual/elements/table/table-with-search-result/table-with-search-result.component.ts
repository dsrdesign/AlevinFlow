...
@Component({
  selector: 'app-table-with-search-result',
  templateUrl: './table-with-search-result.component.html',
  styleUrls: ['./table-with-search-result.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class TableWithSearchResultComponent implements AfterViewInit {
